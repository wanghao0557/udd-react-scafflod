...
var RoomInfo=React.createClass({
  ...
  componentDidMount: function(){ 
    ...
    var sheshis=[];
    $.post(uddh5.apihost+'/getelonghotelproductinfo', {productId: proid,startDate:st,endDate:et, productType: productType, elonghotelId: uddh5.location.queryKey('elonghotelId'), elonghotelCode: uddh5.location.queryKey('elonghotelCode'), elongroomTypeId: uddh5.location.queryKey('elongroomTypeId'), elongproductId: uddh5.location.queryKey('elongproductId'),elongroomId:uddh5.location.queryKey('elongroomId'),resourceType:uddh5.location.queryKey('resourceType')}, function(data){
      //  数据请求回来以后  停止loading
      var requestHybrid = {
          tagname: 'forward',
              topage:'order',
