...
var HotelOrder=React.createClass({
  ...
  handleSubmit: function(e){
    ...
    var elongroomId=uddh5.location.queryKey('elongroomId');
    var forms={
      productId: productid, 
  ...
  componentDidMount: function(){
    ...
    $.post(uddh5.apihost+'/getelonghotelproductinfo', {productId:productid, startDate:uddh5.location.queryKey('starttime'),endDate:uddh5.location.queryKey('endtime'), productType: productType, elonghotelId: uddh5.location.queryKey('elonghotelId'), elonghotelCode: uddh5.location.queryKey('elonghotelCode'), elongroomTypeId: uddh5.location.queryKey('elongroomTypeId'), elongproductId: uddh5.location.queryKey('elongproductId'),elongroomId:uddh5.location.queryKey('elongroomId'),resourceType:uddh5.location.queryKey('resourceType')}, function(data){
      if(data.code == 1){
        var data=data.data;
