...
var Baoxian = React.createClass({
	thisStatus:function(){
		var expressStatus = this.props.expressStatus;
		var expressName = this.props.expressName;
		var expressNo = this.props.expressNo;
		if(expressStatus == 0){
			return(
				<h3 className="pull-right">未寄出</h3>
			)
		}else if(expressStatus == 1){
			return(
				<h3 className="pull-right">已寄出:{expressName}{expressNo}</h3>
			)
		}else if(expressStatus == 2){
			return(
				<h3 className="pull-right">已收到</h3>
			)
		}
	},
	render:function(){
			...
			<div className="baoxian">
				...
				<div className="baoxiao">
					<div className="clearfix">
						<h3 className="pull-left">配送信息</h3>
						{/*{
							(address && (this.props.mobile))?(this.thisStatus()):""
						}*/}
					</div>
					{
